...
var styles = (0, _noParser.css)([['{display:-webkit-inline-box;display:-webkit-inline-flex;display:-ms-inline-flexbox;display:inline-flex;font-family:', (0, _styledTheme.font)('primary'), ';-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;white-space:nowrap;text-transform:uppercase;border:2px solid ', (0, _styledTools.ifProp)('transparent', 'currentcolor', 'transparent'), ';width:auto;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;text-decoration:none;cursor:', (0, _styledTools.ifProp)('disabled', 'default', 'pointer'), ';-webkit-appearance:none;-moz-appearance:none;appearance:none;box-sizing:border-box;pointer-events:', (0, _styledTools.ifProp)('disabled', 'none', 'auto'), ';-webkit-transition:background-color 250ms ease-out,color 250ms ease-out,border-color 250ms ease-out;transition:background-color 250ms ease-out,color 250ms ease-out,border-color 250ms ease-out;background-color:', backgroundColor, ';color:', foregroundColor, ';}'], [':hover,'], [':focus,'], [':active{background-color:', hoverBackgroundColor, ';color:', hoverForegroundColor, ';}'], [':active{background-color:', backgroundColor, ';}'], [':focus{outline:none;}@media (max-width:420px){'], ['{font-size:', (0, _polished.rem)('14px'), ';font-weight:800;height:', (0, _polished.rem)('50px'), ';padding-top:', (0, _styledTools.ifProp)({ type: 'textarea' }, (0, _polished.rem)('16px'), (0, _polished.rem)('16px')), ';padding-bottom:', (0, _styledTools.ifProp)({ type: 'textarea' }, (0, _polished.rem)('16px'), (0, _polished.rem)('16px')), ';border-radius:1px;min-width:295px;}}@media (min-width:421px){'], ['{font-size:', (0, _polished.rem)('18px'), ';font-weight:800;height:', (0, _polished.rem)('60px'), ';padding-top:', (0, _styledTools.ifProp)({ type: 'textarea' }, (0, _polished.rem)('19px'), (0, _polished.rem)('19px')), ';padding-bottom:', (0, _styledTools.ifProp)({ type: 'textarea' }, (0, _polished.rem)('19px'), (0, _polished.rem)('19px')), ';border-radius:3px;min-width:337px;}}']]);
