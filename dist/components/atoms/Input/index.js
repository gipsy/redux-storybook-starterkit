...
var styles = (0, _noParser.css)([['{font-family:', (0, _styledTheme.font)('primary'), ';display:block;width:100%;margin:0;box-sizing:border-box;font-size:0.875rem;padding:', (0, _styledTools.ifProp)({ type: 'textarea' }, '0.4444444444em', '0 0.4444444444em'), ';padding-left:25px;height:', (0, _styledTools.ifProp)({ type: 'textarea' }, 'auto', '3.125rem'), ';color:', (0, _styledTheme.palette)('grayscale', 0), ';background-color:', (0, _styledTheme.palette)('grayscale', 0, true), ';border:2px solid ', (0, _styledTools.ifProp)('invalid', (0, _styledTheme.palette)('danger', 2), (0, _styledTheme.palette)('grayscale', 3)), ';border-radius:1px;-webkit-appearance:none;', (0, _polished.placeholder)({ 'color': (0, _styledTheme.palette)('grayscale', 3, true) }), ';}'], ['[type=checkbox],'], ['[type=radio]{display:inline-block;border:0;border-radius:0;width:auto;height:auto;margin:0 0.2rem 0 0;}']]);

var StyledTextarea = _noParser2.default.textarea.withConfig({
  displayName: 'Input__StyledTextarea',
  componentId: 's1x1476g-0'
})([['{', styles, ';}']]);
var StyledSelect = _noParser2.default.select.withConfig({
  displayName: 'Input__StyledSelect',
  componentId: 's1x1476g-1'
})([['{', styles, ';}']]);
var StyledInput = _noParser2.default.input.withConfig({
  displayName: 'Input__StyledInput',
  componentId: 's1x1476g-2'
})([['{', styles, ';}']]);
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(fontSize, 'fontSize', 'src/components/atoms/Input/index.js');
